...
namespace FaceBook.Marketing.SDK
{
    ...
    public class FacebookResult
    {
        ...
        /// 响应码
        /// </summary>
        public FacebookResultCode Code { get; set; }
        /// <summary>
        /// 响应信息
        /// </summary>
        ...
        /// 成功
        /// </summary>
        public bool IsSuccess => Code == FacebookResultCode.Succeed;
        /// <summary>
        /// 时间戳(毫秒)
        /// </summary>
        ...
        {
            Message = message;
            Code = FacebookResultCode.Succeed;
        }
        /// <summary>
        /// 响应失败
        /// </summary>
        ...
        {
            Message = message;
            Code = FacebookResultCode.Failed;
        }
        /// <summary>
        /// 响应失败
        /// </summary>
    ...
    public class FacebookResult<T> : FacebookResult
    {
        /// <summary>
        /// 返回结果
        /// </summary>
